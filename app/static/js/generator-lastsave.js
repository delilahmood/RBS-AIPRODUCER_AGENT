...
// ===== CARTE "READY"/"QUEUED" (étape cochée, jamais encore lancée) =====
...
function renderSceneStoryboardGroup(scene, liveData) {
    ...
    if (!cardUiState[uiKey]) cardUiState[uiKey] = { historyOpen: false, generating: false, selectedModel: SHEET_MODELS[0], usePromptDirector: true };
    const ui = cardUiState[uiKey];
