                ...
                if not all_scenes:
                    ...
                    for scene in all_scenes:
                        ...
                        for cid in (scene.character_ids or []):
                            ...
                            for asset_type in ("portrait", "reference_sheet"):
                                ...
                                if asset and asset.file_url:
                                    ref_paths.append(os.path.join("app", asset.file_url.lstrip("/")))
                        if scene.location_id:
                            ...
                            if loc_asset and loc_asset.file_url:
                                ref_paths.append(os.path.join("app", loc_asset.file_url.lstrip("/")))
                        ...
                        result = self.storyboard_art.generate_storyboard_frame(
                            shot_dict, ref_paths, visual_styles, batch_number=next_batch,
                            character_names=character_names,
